...
(/** @lends <global> */function( $ ) {
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		if ( tableWidthAttr ) {
			...
			if ( ! oSettings._reszEvt ) {
				$(window).bind('resizeTextArea.DT-'+oSettings.sInstance, _fnThrottle( function () {
	...
	DataTable = function( options )
	{
		 ...
		 * parent element changes (for example a window resizeTextArea).
		 ...
		 *      } );
		 *
		 *      $(window).bind('resizeTextArea', function () {
