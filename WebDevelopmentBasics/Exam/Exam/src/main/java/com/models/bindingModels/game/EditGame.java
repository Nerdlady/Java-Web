...
public class EditGame {
    ...
    private List<LoggedUser> usersBought;
    private List<LoggedUser> usersCart;
    ...
    public List<LoggedUser> getUsersBought() {
        return usersBought;
    }

    public void setUsersBought(List<LoggedUser> usersBought) {
        this.usersBought = usersBought;
    }

    public List<LoggedUser> getUsersCart() {
        return usersCart;
    }

    public void setUsersCart(List<LoggedUser> usersCart) {
